...
public class ReimbursementService {
	private ReimbursementDAO reimbursemntDao = new ReimbursementDAO();
    ...
    public List<Reimbursement> getReimbursementByAuthor(int id) {
		return reimbursemntDao.getReimbursementByAuthor(id);
	}
    
    public Reimbursement create(Reimbursement reimbursement) {
		return reimbursemntDao.create(reimbursement);
	}

	public List<Reimbursement> getAllReimbursement() {
		return reimbursemntDao.getAllReimbursement();
	}
	public Reimbursement update(Reimbursement unprocessedReimbursement) {
		return reimbursemntDao.update(unprocessedReimbursement);
	}
